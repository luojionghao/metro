...
var pathArrayR;
var time,timeCount;
var conArray = [{ x: 38374.5, y: 639.2, z: 10 }, { x: 38388.5, y: 639.3, z: 2.64 }, { x: 38393.5, y: 639.23, z: 3.54 }, { x: 38403.5, y: 640.3, z: 2.67 }, { x: 38423.5, y: 641.1, z: 3.1 }, { x: 38437.5, y: 642.2, z: 1.5 }, { x: 38464.5, y: 645.2, z: 0.21 }, { x: 38506.5, y: 647.21, z: 2.1 }, { x: 38534.5, y: 649.22, z: 1.1 }, { x: 38543.5, y: 649.42, z: 1.5 }, { x: 38560.5, y: 650.22, z: 2.1 }, { x: 38571.5, y: 651.22, z: 1.9 }, { x: 38581.5, y: 652.22, z: 3.1 }, { x: 38590.5, y: 653.22, z: 2.4 }, { x: 38599.5, y: 654.22, z: 2.2 }, { x: 38608.5, y: 655.22, z: 1.2 }, { x: 38618.5, y: 656.22, z: 3.4 }, { x: 38634.5, y: 657.22, z: 2.1 }, { x: 38644.5, y: 658.22, z: 3.1 }, { x: 38654.5, y: 659.22, z: 1.4 }, { x: 38664.5, y: 659.62, z: 2.6}, { x: 38674.5, y: 660.22, z: 2.1 }, { x: 38684.5, y: 660.62, z: 1.1 }, { x: 38694.5, y: 661.22, z: 2.1 }, { x: 38704.5, y: 661.62, z: 3.1 }, { x: 38714.5, y: 662.22, z: 1.1 }, { x: 38724.5, y: 662.62, z: 2.1}, { x: 38734.5, y: 663.22, z: 2.5 }, { x: 38744.5, y: 663.62, z: 1.4 }, { x: 38754.5, y: 664.62, z: 1.1 }];
getLinedata();
console.log($("#sectionSvgUrl"));
...
Snap.load($("#sectionSvgUrl").val(), function(svg) {
    ...
    getRisk(rpArray);
     ...
     var pathR = Snap(document.getElementById("lineL")).attr({ visibility: "hidden" });
    ...
    // getRingInfo(mSVG,pathL,pathArrayL, countL,lLinedata,$("#lvl").val(), "左线");
...
function moveToNum(goNum) {
    ...
    console.log(time);
    var linepoint1 = getlinepath(pathArrayR[goNum * 4].node);
    moveToCenter(mSVG, linepoint1);
    var lineR = Snap(document.getElementById("lineR"));
    var polygonArrayR = lineL.selectAll("polygon");
   ...
   console.log(lineData);
    for (var i = 0; i < count; i++) {
        ...
        circle.dblclick(function () {
            window.parent.gotoTab2(this.index + 1,"右线");
        });
...
function getRisk(riskData) {
    for (var i = 0; i < riskData.length; i++){
        if(riskData[i].leftOrRight == "r" && riskData[i].gType == 2) {
