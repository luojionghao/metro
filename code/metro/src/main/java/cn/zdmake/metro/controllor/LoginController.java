...
public class LoginController extends BaseController {
	...
	@ResponseBody
	public CommonResponse checkLogin(@RequestParam("username") String u_name, @RequestParam("password") String u_pass,
	...
	@ResponseBody
	public ModelMap saveNewPassword(@RequestParam("oldpass") String oldpass, @RequestParam("newpass") String newpass) {
