...
<body class="sidebar-mini skin-blue wysihtml5-supported">
		...
		<div class="box">
            ...
            <div class="box-body">
                <div class="row no-pad">
                    <div class="col-sm-12">
                    <!-- 表格模块 -->
                    <table id="monitorCityTable" class="table table-bordered table-hover dataTable">
                        <thead>
                            <tr>
	                            <th>区间</th>
	                            <th>线路</th>
	...
	// 初始化表格
	var table = zookeTable('#monitorCityTable',{
	...
	var pagination = zookePagination('#pagination',{
	    pageSize:10,
	    remote:{
	        url:"<@s.url'/monitor/info/find/city/datas'/>",
