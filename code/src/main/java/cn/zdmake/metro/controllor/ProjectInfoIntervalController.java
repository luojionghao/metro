...
public class ProjectInfoIntervalController extends BaseController {
	...
	@ResponseBody
	public String uploadImgMapXyFile(MultipartHttpServletRequest request){
		CommonResponse r= new CommonResponse();
		try{
			String fileId = request.getParameter("fileId");
			String intervalId = request.getParameter("intervalId");
	...
	@ResponseBody
	public String uploadMdreFile(MultipartHttpServletRequest request){
		CommonResponse r= new CommonResponse();
		try{
			String fileId = request.getParameter("fileId");
			String intervalId = request.getParameter("intervalId");
			...
			CommonResponse result = commonService.fileUpload(mf);
			if(result.getCode() == Constants.CODE_SUCCESS){
				boolean updateR = lineIntervalMdReService.uploadLineIntervalMdReData(Long.parseLong(intervalId), (String)result.getResult());
				if(updateR){
					return GsonUtils.toJson(result);
				}else{
					logger.error("文件上传成功，更新数据库失败");
	...
	public String findSpinfo(){
		...
		PageResultSet<MetroLineIntervalSp> resultSet = lineIntervalSpService.findLineIntervalSpInfo(Long.parseLong(intervalId), pageNum, pageSize);
	...
	@ResponseBody
	public String findStinfo(){
		String intervalId = request.getParameter("intervalId");
		int pageNum = StringUtil.nullToInt(request.getParameter("pageNum"));
		int pageSize = StringUtil.nullToInt(request.getParameter("pageSize"));
		PageResultSet<MetroLineIntervalSt> resultSet = lineIntervalStService.findLineIntervalStInfo(Long.parseLong(intervalId), pageNum, pageSize);
		return GsonUtils.toJson(resultSet);
	}
	...
	@ResponseBody
	public String findSainfo(){
		String intervalId = request.getParameter("intervalId");
		int pageNum = StringUtil.nullToInt(request.getParameter("pageNum"));
		int pageSize = StringUtil.nullToInt(request.getParameter("pageSize"));
		PageResultSet<MetroLineIntervalSa> resultSet = lineIntervalSaService.findLineIntervalSaInfo(Long.parseLong(intervalId), pageNum, pageSize);
		return GsonUtils.toJson(resultSet);
	}
	...
	@ResponseBody
	public String findMdreinfo(){
		String intervalId = request.getParameter("intervalId");
		int pageNum = StringUtil.nullToInt(request.getParameter("pageNum"));
		int pageSize = StringUtil.nullToInt(request.getParameter("pageSize"));
		PageResultSet<MetroLineIntervalMdRe> resultSet = lineIntervalMdReService.findLineIntervalMdReInfo(Long.parseLong(intervalId), pageNum, pageSize);
		return GsonUtils.toJson(resultSet);
	}
	...
	@ResponseBody
	public String findRiskinfo(){
		String intervalId = request.getParameter("intervalId");
		int pageNum = StringUtil.nullToInt(request.getParameter("pageNum"));
		int pageSize = StringUtil.nullToInt(request.getParameter("pageSize"));
		PageResultSet<MetroLineIntervalRp> resultSet = lineIntervalRpService.findLineIntervalRpInfo(Long.parseLong(intervalId), pageNum, pageSize);
		return GsonUtils.toJson(resultSet);
	}
	...
	@ResponseBody
	public String savRiskinfo(MetroLineIntervalRp rp){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String updateRiskinfo(MetroLineIntervalRp rp){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String uploadRiskFile(MultipartHttpServletRequest request){
		CommonResponse r= new CommonResponse();
		try{
			String fileId = request.getParameter("fileId");
			MultipartFile mf = request.getFile(fileId);
			...
			if(result.getCode() == Constants.CODE_SUCCESS){
				...
				r.setCode(Constants.CODE_FAIL);
				r.setResult("上传风险位置失败");
			}
		}catch(Exception e){
			logger.error("风险位置文件上传异常", e);
			r.setCode(Constants.CODE_FAIL);
			r.setResult("风险位置文件上传异常");
		}
		return GsonUtils.toJson(r);
	}
	...
	@ResponseBody
	public String uploadRiskImg(MetroLineIntervalRp rp){
		CommonResponse r= new CommonResponse();
	...
	@ResponseBody
	public String uploadRiskPdf(MetroLineIntervalRp rp){
		CommonResponse r= new CommonResponse();
		try{
			boolean result = lineIntervalRpService.updateRiskPdf(rp.getId(),rp.getRiskPdf1Url(),rp.getRiskPdf2Url(),rp.getRiskPdf3Url());
			if(result){ //更新保存成功
				r.setCode(Constants.CODE_SUCCESS);
				r.setResult("更新成功");
			}else{
	...
	@ResponseBody
	public String savSpinfo(MetroLineIntervalSp sp){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String updateSpinfo(MetroLineIntervalSp sp){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String savSainfo(MetroLineIntervalSa sa){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String updateSainfo(MetroLineIntervalSa sa){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String savStinfo(MetroLineIntervalSt st){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String updateStinfo(MetroLineIntervalSt st){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String exportShieldinfo(){
		CommonResponse r = new CommonResponse();
		try{
			String intervalId = request.getParameter("intervalId");
			String leftOrRight = request.getParameter("leftOrRight");
			...
			Map<String,Object> datas = lineIntervalService.getShieldData(Long.parseLong(intervalId),leftOrRight,date,ring,key,type);
		...
		try{
			...
			if(CommonUtils.isNotNull(datas)){
				for(int i = 0;i<datas.size();i++){
					...
					sheet.addCell(new Label(5, i+1, String.valueOf(data.getSpSumAdd()!=null?data.getSpSumAdd():"")));
					sheet.addCell(new Label(6, i+1, String.valueOf(data.getSpSumSub()!=null?data.getSpSumSub():"")));
					sheet.addCell(new Label(7, i+1, String.valueOf(data.getSpSpeedWarningVal()!=null?data.getSpSpeedWarningVal():"")));
				}
			}
			book.write();
			return filename;
		...
		try{
			...
			if(CommonUtils.isNotNull(datas)){
				...
				for(Map.Entry<String,Object> entry : datas.entrySet()){
					sheet.addCell(new Label(0, i+1, String.valueOf(entry.getValue()!=null?entry.getValue():"")));
	...
	@ResponseBody
	public String importStinfo(@RequestParam("intervalId")String intervalId, @RequestParam(value="file",required=false) MultipartFile file){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String importSainfo(@RequestParam("intervalId")String intervalId, @RequestParam(value="file",required=false) MultipartFile file){
		CommonResponse r = new CommonResponse();
		try{
	...
	public String importLrinfo(@RequestParam("intervalId")String intervalId, @RequestParam(value="file",required=false) MultipartFile file){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String saveOrUpdateLineIntervalPpInfo(MetroLineIntervalPp pp){
		CommonResponse r = new CommonResponse();
		try{
				...
				for(MetroLine line : city.getLineList()){
					...
					if(CommonUtils.isNotNull(line.getIntervalList())){
						for(MetroLineInterval interval : line.getIntervalList()){
							...
							lineChild.setUrl(request.getContextPath()+"/project-info/interval/intervalinfo"+"?intervalId="+interval.getId());
	...
	@ResponseBody
	public String uploadLineIntervalMdReData(){
		CommonResponse r = new CommonResponse();
		try{
			String intervalId = request.getParameter("intervalId");
			...
			boolean result = lineIntervalMdReService.uploadLineIntervalMdReData(Long.parseLong(intervalId),uploadFileUrl);
			if(result){ //上传成功
				r.setCode(Constants.CODE_SUCCESS);
				r.setResult("上传成功");
			}else{ //上传失败
				...
				r.setCode(Constants.CODE_FAIL);
				r.setResult("沉降点监测数据上传失败");
			}
		}catch(Exception e){
			logger.error("沉降点监测数据上传异常", e);
			r.setCode(0);
			r.setResult("沉降点监测数据上传异常");
		}
		return GsonUtils.toJson(r);
	}
