...
public class ProjectInfoBasicController extends BaseController {
	...
	@ResponseBody
	public String saveLineinfo(MetroLine line){
		CommonResponse r = new CommonResponse();
		try{
			//line.getLineNo();
			//System.out.println(GsonUtils.toJson(line));
	...
	@ResponseBody
	public String saveIntervalinfo(MetroLineInterval interval){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String updateLineinfo(MetroLine line){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String updateLineIntervalInfo(MetroLineInterval interval){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String updateLineIntervalLrInfo(){
		CommonResponse r = new CommonResponse();
		try{
	...
	@ResponseBody
	public String deleteIntervalinfo(){
		CommonResponse r = new CommonResponse();
		try{
			String intervalId = request.getParameter("intervalId");
	...
	public String uploadCityProjectPdf(@RequestParam("cityId")String cityId,@RequestParam(value="file",required=false) MultipartFile file){
		CommonResponse r = new CommonResponse();
		try{
	...
	public String uploadLineProjectPdf(@RequestParam("lineId")String lineId,@RequestParam(value="file",required=false) MultipartFile file){
		CommonResponse r = new CommonResponse();
		try{
			CommonResponse uploadResult = commonService.fileUpload(file);
			if(uploadResult.getCode() == Constants.CODE_FAIL){ //上传文件失败
	...
	public String uploadLineIntervalProjectPdf(@RequestParam("intervalId")String intervalId,@RequestParam(value="file",required=false) MultipartFile file){
		CommonResponse r = new CommonResponse();
		try{
			CommonResponse uploadResult = commonService.fileUpload(file);
			if(uploadResult.getCode() == Constants.CODE_FAIL){ //上传文件失败
	...
	@ResponseBody
	public String deleteCityProjectPdf(){
		CommonResponse r = new CommonResponse();
		try{
			String cityId = request.getParameter("cityId");
	...
	@ResponseBody
	public String deleteLineProjectPdf(){
		CommonResponse r = new CommonResponse();
		try{
			String lineId = request.getParameter("lineId");
			MetroLine line = new MetroLine();
	...
	@ResponseBody
	public String deleteLineIntervalProjectPdf(){
		CommonResponse r = new CommonResponse();
		try{
			String intervalId = request.getParameter("intervalId");
			MetroLineInterval interval = new MetroLineInterval();
