...
public class MetroMonitorInfoCityService implements IMetroMonitorInfoCityService{
	...
	private final static String[] KPSS ={"A0001","A0002","A0003","A0004","A0005","A0006","A0007","A0008",
										 "A0009","A0011","B0001","B0002","B0004","B0006","B0011","B0012",
										 "C0001","C0003","C0005","C0007","C0009","C0011","C0013","C0015",
										 "D0008","D0010","D0012","D0014","D0016","D0018","D0020","D0022",
										 "D0023","E0002","E0004","E0006","E0008","E0010","E0012","E0014",
										 "E0016","E0019","F0001","F0002","F0005","F0006","G0002","G0003",
										 "G0004","G0006","G0007","G0008","G0010","G0011","G0012","G0014",
										 "G0015","G0016","G0018","G0019","G0020","G0022","G0023","G0024",
										 "G0026","G0027","G0028","G0030","G0031","G0032","H0042","H0043",
										 "H0040","H0041","I0020","J0001","J0002","J0003","J0004","J0005",
										 "J0006","J0007","J0008","J0009","J0010","J0011","J0012","J0020",
										 "J0021","J0022","J0023","J0024","J0025","J0026","J0027","J0028",
			                             "J0029","J0030","R0001","R0002","R0003","R0004","R0005","R0006",
			                             "R0007","R0008","R0009","R0010","R0011","R0012","R0013","R0014",
			                             "R0015","R0016","R0017","R0018","R0019","R0020","R0021","R0022",
			                             "R0023","R0024","A0013"};
	...
	private final static String[] MODEL3 = {"C0913", "C0105", "J0025", "J0027"};//(C0009-C0013) AS C0913;(C0001-C0005) AS C0105
	private final static String[] MODEL4 = {"B0011", "B0012"};
	private final static String[] MODEL5 = {"C1511", "C0703", "J0024", "J0026"};//(C0015-C0011) AS C1511;  (C0007-C0003) AS C0703
	...
	@Override
	public PageResultSet<MonitorViewData> findMonitorInfoCityData(Long cityId, Long lineId,
																  int buildStatus, int pageNum, int pageSize) throws IOException {
		...
		if (total > 0) {
			...
			for(MonitorInfoCity mic : mics){				
				...
				for(String p : KPS){
					keys.add(IhistorianUtil.getKey(mic.getLineNo(), 
							mic.getIntervalMark(), mic.getLeftOrRight(), p));
				}
				list.add(mvd);
			}
			...
			if(ir!=null&&ir.getCode()==200){
				...
				for(MonitorInfoCity mic : mics){
					    ...
					    if(obj!=null){
							...
							Map<String,Object> resultMap = mapper.readValue(A0001,HashMap.class);
	...
	public Map<String, String> findCountMechineDatas(Long userId, Long lineId) {
		...
		if(ir!=null&&ir.getCode()==200&&ir.getResult()!=null){
			map.put("totalSuccess",ir.getResult().get("success")!=null?ir.getResult().get("success").toString():"0");
	...
	@Override
	public Map<String, Object> findIntervalLrDaoPanDatas(Long intervalId,
			String leftOrRight) {
		Map<String, Object> params = new HashMap<>();
		...
		if(mic!=null){
			...
			if(ir!=null&&ir.getCode()==200&&ir.getResult()!=null){
				map = ir.getResult();
				String key = "GZ"+mic.getLineNo()+"_"+mic.getIntervalMark()+mic.getLeftOrRight().toUpperCase()+"."+"A0001.F_CV";
				...
				if(nowRingNum>0){
					...
					ks.add("GZ"+mic.getLineNo()+"_"+mic.getIntervalMark()+mic.getLeftOrRight().toUpperCase()+"."+"J0020.F_CV");
					ks.add("GZ"+mic.getLineNo()+"_"+mic.getIntervalMark()+mic.getLeftOrRight().toUpperCase()+"."+"J0021.F_CV");
				...
				if (front != null){
                    ...
                    if(frontDataMin !=null && frontDataMax != null) {
						double hfront = MathUtil.getHdeviation(StringUtil.nullToDouble(front.get("mapX").toString()),
								StringUtil.nullToDouble(front.get("mapY").toString()), frontDataMin.getMapX().doubleValue()
								, frontDataMin.getMapY().doubleValue(), frontDataMax.getMapX().doubleValue(), frontDataMax.getMapY().doubleValue());
				...
				if (medium != null){
					...
					if(mediumDataMin !=null && mediumDataMax != null) {
						double hMedium = MathUtil.getHdeviation(StringUtil.nullToDouble(medium.get("mapX").toString()),
								StringUtil.nullToDouble(medium.get("mapY").toString()), mediumDataMin.getMapX().doubleValue()
								, mediumDataMin.getMapY().doubleValue(), mediumDataMax.getMapX().doubleValue(), mediumDataMax.getMapY().doubleValue());
				...
				if (back != null){
					...
					if(backDataMin !=null && backDataMax != null) {
						double hBack = MathUtil.getHdeviation(StringUtil.nullToDouble(back.get("mapX").toString()),
								StringUtil.nullToDouble(back.get("mapY").toString()), backDataMin.getMapX().doubleValue()
								, backDataMin.getMapY().doubleValue(), backDataMax.getMapX().doubleValue(), backDataMax.getMapY().doubleValue());
			...
			map.put("head", "GZ"+mic.getLineNo()+"_"+mic.getIntervalMark()+mic.getLeftOrRight().toUpperCase()+".");
		}
	...
	@Override
	public PageResultSet<MonitorLrAlldicView> findMonitorIntervalLrDics(
		...
		if(mic!=null){
			...
			for(MetroDictionary dic:dics){
				keys.add(IhistorianUtil.getKey(mic.getLineNo(), 
						mic.getIntervalMark(), mic.getLeftOrRight(), dic.getDicName()));
			}
			IhistorianResponse ir = IhistorianUtil.getDataByKeys(keys);	
	...
	public MonitorIntervalView findMonitorIntervalDatas(Long intervalId, Long intervalSpId) {
		...
		if(mic!=null){
			...
			miv.setTitle("["+mic.getLineName()+"-"+mic.getIntervalMark()+"标-"+mic.getIntervalName()+"-"+("l".equals(mic.getLeftOrRight())?"左":"右")+"线]监测数据");
			miv.setIntervalSpId(intervalSpId);
			List<String> keys = new ArrayList<String>();
			for(String k:KPSM){
				keys.add(IhistorianUtil.getKey(mic.getLineNo(), 
						mic.getIntervalMark(), mic.getLeftOrRight(), k));
			}
					...
					if(irr!=null&&irr.getCode()==200&&irr!=null){						
						...
						if(list!=null&&list.size()>0){
							...
							for(Map mp : list){
								...
								vl.add((mile!=null?Float.parseFloat(mile.toString()):0)-mlis.getOriginMileage());
								vl1.add((mile!=null?Float.parseFloat(mile.toString()):0)-mlis.getOriginMileage());
	...
	@Override
	public Map<String, Object> findIntervalLrDaoxDatas(Long intervalId,
			String leftOrRight) {
		Map<String, Object> params = new HashMap<>();
	...
	@Override
	public List<List<Object>> findMonitorStaticTab1(String intervalId,
		...
		if(mic!=null){
			List<String> keys = new ArrayList<String>();
			keys.add(IhistorianUtil.getKey(mic.getLineNo(), 
						mic.getIntervalMark(), mic.getLeftOrRight(), paramName));
	...
	@Override
	public List<List<Object>> findMonitorStaticTab2(String intervalId,
			String leftOrRight, String beginRing, String endRing) {
		List<List<Object>> res = new ArrayList<List<Object>>();
		Map<String, Object> params = new HashMap<>();
		params.put("intervalId", intervalId);
		...
		if(mic!=null){
			String key = IhistorianUtil.getKey(mic.getLineNo(), 
						mic.getIntervalMark(), mic.getLeftOrRight(), "A0002");
			List<String> rings = new ArrayList<String>();
	...
	@Override
	public PageResultSet<MonitorIntervalLrStaticView> findMonitorStaticTab4(
		...
		MonitorInfoCity mic = monitorCityDao.findMonitorInfoCity(params);
		if(mic!=null){
			String timerequest = IhistorianUtil.getKey(mic.getLineNo(), 
						mic.getIntervalMark(), mic.getLeftOrRight(), "A0002");
			String key1 = IhistorianUtil.getKey(mic.getLineNo(), 
					mic.getIntervalMark(), mic.getLeftOrRight(), "D0023");
			String key2 = IhistorianUtil.getKey(mic.getLineNo(), 
					mic.getIntervalMark(), mic.getLeftOrRight(), "G0001");
			List<String> keys = new ArrayList<String>();
			keys.add(key1);
			keys.add(key2);
			...
			try {
				...
				IhistorianResponse ir = IhistorianUtil.getDataByKeyAndBeTime(sdf.parse(b),sdf.parse(e),timerequest,keys);
				if(ir!=null&&ir.getCode()==200&&ir.getResult()!=null){
			...
			if("1".equals(excelType)){//日
				...
				for(MonitorIntervalLrStaticView mv : data){
					...
					if(i==0||day==2){//记录第一和每周第一
						...
						m.setLineMark(mic.getLineNo()+"号线-"
								+mic.getIntervalName()+"-"
	...
	public MonitorIntervalLrStaticsView findMonitorStaticTab5(String intervalId, String leftOrRight, int model,
			String type, String beginTime, String endTime, int beginRing,
			int endRing, String[] ks, String[] kns, String[] indxs) {
		...
		if(mic!=null){
			...
			String KEY_A0001 = IhistorianUtil.getKey(mic.getLineNo(),
					mic.getIntervalMark(), mic.getLeftOrRight(), "A0001");
			keys.add(KEY_A0001);
...
//						}					
				...
				for(int j=0;j<keysSize;j++){
					...
					for(Map m : list){
						...
						while(ii.hasNext()){
							HashMap<String, Object> vv = JSONArray.parseObject(m.get(ii.next()).toString(),HashMap.class);
