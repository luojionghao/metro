...
//	private final static String res = "";
	...
	public static IhistorianResponse getDataByKeys(List<String> keys){
		...
		try{
			...
			NameValuePair pvp = new BasicNameValuePair("parameters",Tea.encryptByBase64Tea(GsonUtils.toJson(map)));
			params.add(pvp);		
	...
	/**
	 * 获取key 
	 * @param lineNo 线路编号 21
	 * @param intervalMark 区间标号 16
	 * @param leftOrRight 左右线标记 L
	 * @param param 参数名 A0001 来源于字典表
	 * @return GZ21_16L.A0001.F_CV 
	 */
	public static String getKey(int lineNo,int intervalMark,String leftOrRight,String param){
		return "GZ"+lineNo+"_"+intervalMark+leftOrRight.toUpperCase()+"."+param+".F_CV";
	}
	...
	public static String getKey(int lineNo,int intervalMark,String leftOrRight){
		return "GZ"+lineNo+"_"+intervalMark+leftOrRight.toUpperCase();
	}
	 ...
	 * @return
	 */
	public static IhistorianResponse getDataByKeysAndRingNums(List ringarr,
			List<String> ks) {
		IhistorianResponse ires = new IhistorianResponse();
		try{
			Map<String, Object> map = new HashMap<>();
	 ...
	 * @return
	 */
	public static IhistorianResponse getDataByKeysAndRings(List<String> keys,
			List<String> rings) {
		IhistorianResponse ires = new IhistorianResponse();
		try{
			Map<String, Object> map = new HashMap<>();
	 ...
	 * @return
	 */
	public static IhistorianResponse getDataByKeysAndRingsTime(List<String> keys,
			List<String> rings) {
		IhistorianResponse ires = new IhistorianResponse();
		try{
			Map<String, Object> map = new HashMap<>();
	 ...
	 * @return
	 */
	public static IhistorianResponse getDataByKeyAndRings(String key,
			List<String> rings) {
		IhistorianResponse ires = new IhistorianResponse();
		try{
			Map<String, Object> map = new HashMap<>();
	 ...
	 * @return
	 */
	public static IhistorianResponse getDataByKeyAndTime(String key, Date bd,
			Date ed) {
		IhistorianResponse ires = new IhistorianResponse();
		try{
			Map<String, Object> map = new HashMap<>();
	 ...
	 * @return
	 */
	public static IhistorianResponse getDataByKeyAndBeTime(Date parse,
			Date parse2, String timerequest, List<String> keys) {
		IhistorianResponse ires = new IhistorianResponse();
		try{
			Map<String, Object> map = new HashMap<>();
	 ...
	 * @param keys 参数数组
	 * @param rings 环号数组
	 * @param fixedcount 模式1-7种 当为0时代表无模式
	 * @param key_h 到区间左右线key前缀
	 * @return
	 */
	 ...
	 * @return
	 */
	public static IhistorianResponse getDataByKeysAndBeTime(List<String> keys, Date beginTime, Date endTime, int fixedcount, String key_h){
		IhistorianResponse ires = new IhistorianResponse();
		try{
			Map<String, Object> map = new HashMap<>();
...
//		keys.add("GZ21_16L.A4579.F_CV");
//		keys.add("GZ21_16L.B0006.F_CV");
//		keys.add("GZ21_16L.E0019.F_CV");
...
//		rings.add("822");
//		rings.add("824");
//		IhistorianResponse ir = getDataByKeysAndRingsTime(keys,rings);
		Date d=new Date();

		//IhistorianResponse ir = getTodayRing("GZ21_16L");
